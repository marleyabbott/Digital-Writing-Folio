...
#### 500-Word Reflection on Class and Practice Development:

When I began this digital writing studio, I carried a deep scepticism about technology's place in creative practice. My writing has always been rooted in place-based methods and embodied experience. I prefer writing in nature, away from screens. The prospect of coding for hours felt antithetical to my creative process. Yet through this class, I've discovered that digital writing offers unique affordances for exploring the very themes that drive my work: translation, displacement, inherited memory, and the spaces between understanding and misunderstanding.
My final work, 'The Tank', emerged from a family story that has long resisted traditional narrative forms. The water tank my mother lived in as a child after migrating from Calabria to regional Victoria existed in my imagination as fragments: inherited memories that felt simultaneously intimate and foreign. The digital format, particularly Twine's branching structure, offered a way to replicate the non-linear nature of how family stories are transmitted. They are interrupted, retold, emotionally charged, and often incomplete.
Working with Twine Harlowe revealed both the possibilities and constraints of digital platforms. While Twine excelled at creating the illusion of choice (mirroring the false choices available to migrants in 1960s Australia), it also presented significant technical limitations. My vision required a visual transformation from clean editorial aesthetic to chaotic kitchen table, representing the protagonist's emotional fragmentation. Achieving this through CSS proved challenging within Harlowe's constraints. Simple tasks like implementing layered soundscapes or complex visual effects required workarounds.
The most significant limitation was Harlowe's handling of multimedia elements. I envisioned archival recordings of my Nonna and Nonno speaking Calabrese layered over English text to create linguistic dissonance. While I could incorporate one consistent audio piece, the platform couldn't support the complex, overlapping soundscape which builds throughout the story as I had imagined. Similarly, my plan to use family photographs as interactive maps required extensive CSS manipulation that pushed against Harlowe's intended functionality.
Despite these constraints, the platform's limitations became generative. The struggle to execute my vision within technical boundaries paralleled the protagonist's struggle to understand a language she only half-knows. When some code broke or behaved unexpectedly, it created visually fragmented or tilted passages that enhanced the work's themes of miscommunication and disorientation. Because I pushed the platform so aggressively, coding instabilities emerged that made each playthrough slightly different and unpredictably glitchy. Hours of troubleshooting became the norm. Fixing one passage would break another, creating cascading problems that required constant debugging. The amount of custom code meant the piece barely held together. While frustrating, these failures did mirror the unreliable nature of inherited memory and the threads of the story itself, which are held together by word of mouth.
This studio fundamentally shifted my understanding of readership. I previously thought of readers as static consumers, but electronic literature allows readers to be collaborators and co-creators. In 'The Tank', the reader doesn't just consume the family story. They navigate it, make choices within it, and experience the disorientation of moving between homes, timelines and generations. This participatory engagement transforms the work from a memoir into what I now think of as a family archive glitched by geography, grief, and the unreliability of storytelling and memory.
This studio challenged my assumption that coding is a logical and constraining exercise. I discovered coding to be surprisingly creative. One decision affects many others, acting more like painting than mathematics. While I maintain my preference for analogue practice methods, I now see digital writing as another tool for excavating the stories that resist traditional forms. Creating ‘The Tank’ on twine proved that some stories need new architectures to be fully experienced rather than simply read.
